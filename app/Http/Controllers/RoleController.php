...
class RoleController extends Controller
{
    ...
    public function show(Role $role)
    {
        ...
        $data = $this->roleService->oneRole($role);
     ...
     * @return response  of the status of operation and the role
     */
    public function addPermissionToRole(AddPermissionsRequest $request, Role $role)
    {
        $permissionsData = $request->validated();
        $this->roleService->addPermissionToRole($role, $permissionsData);
        return response()->json([
            'status' => 'success',
        ], 200);
    }
     ...
     * @return response  of the status of operation and the role
     */
    public function removePermissionFromRole(RemovePermissionsRequest $request, Role $role)
    {
        $permissionsData = $request->validated();

        $this->roleService->removePermissionFromRole($role, $permissionsData);
        return response()->json([
            'status' => 'success',
        ], 200);
    }
